...
export default function IpOptionsDropdown(props){
    ...
    return (
        <div className={props.active?"activeContext PD":"PD"}>
            <p onClick={() => handleRename()}><i className="far fa-file-alt" onClick={() => handleRename()}></i> Rename</p>
            <p onClick={() => handleDelete()}><i className="far fa-edit" onClick={() => handleDelete()}></i> Delete</p>
        </div>
    )
